...
class Api::V2::ProductsControllerTest < ActionController::TestCase
  ...
  def test_update
    put :update, :id => @product.cp_id, :product => {:name => 'New Name'}
  ...
  def test_update_product_requires_name
    put :update, :id => @product.cp_id, :product => {:name => nil}
  ...
  def test_remove_sync_plan
    put :update, :id => @product.cp_id, :product => {:sync_plan_id => nil, :provider_id => @provider.id}
